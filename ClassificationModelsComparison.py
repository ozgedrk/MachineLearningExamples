...
# n_redundant bilgi icermeyen -- n_informative bilgi iceren 
...
i = 1
# enumerate data setteki verileri x ve y ile indexli olarak esitlemek icin kulandik.
...
names = ["Nearest Neighbors", "Linear SVM", "Desicion Tree", "Random Forest", "Naive Bayes"]
...
for ds_count, ds in enumerate(datasets):
    ...
    for name, clf in zip(names,classifiers):
       ...
       # StandardScaler().clf.fit()
        ...
        score = clf.score(X_test, y_test) # accuracy degeri
