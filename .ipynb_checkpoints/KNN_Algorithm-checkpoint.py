...
knn.fit(X_train , y_train) # fit fonskiyonu verimizi (samples + target) kullanarak KNN algoritmasini egitir
...
plt.title("K Degerine Gore Doguruluk")
plt.xlabel("K Deferi")
plt.ylabel("Dogruluk")
plt.xticks(k_values)
plt.grid(True)
...
for i, weight in enumerate(["uniform", "distance"]):
    ...
    plt.axis("tight")  # Here, use plt.axis instead of plt.axes
    plt.legend()
